...
class TestStatisticsUtils(unittest.TestCase):
    ...
    def test_moving_average_raises_for_invalid_window(self):
        ...
        Escenario esperado:
        - Llamar a moving_average con window=0 (valor no positivo) y verificar ValueError
        - Llamar a moving_average con window mayor que la longitud del array y verificar ValueError
        """
        utils = StatisticsUtils()
        arr = [1, 2, 3]
    ...
    def test_moving_average_only_accepts_1d_sequences(self):
        ...
        - Llamar a moving_average y verificar que se lanza un ValueError
        """
        utils = StatisticsUtils()
        arr_2d = [[1, 2], [3, 4]]
    ...
    def test_zscore_has_mean_zero_and_unit_std(self):
        ...
        self.assertAlmostEqual(np.std(result, ddof=0), 1.0, places=7)
    ...
    def test_zscore_raises_for_zero_std(self):
        ...
        - Llamar a zscore y verificar que se lanza un ValueError
        """
        utils = StatisticsUtils()
        arr = [5, 5, 5]
    ...
    def test_min_max_scale_maps_to_zero_one_range(self):
        ...
        - Verificar que los valores transformados son correctos (ej: [0.0, 0.5, 1.0])
        """
        utils = StatisticsUtils()
        arr = [2, 4, 6]
    ...
    def test_min_max_scale_raises_for_constant_values(self):
        ...
        - Llamar a min_max_scale y verificar que se lanza un ValueError
        """
        utils = StatisticsUtils()
        arr = [3, 3, 3]
